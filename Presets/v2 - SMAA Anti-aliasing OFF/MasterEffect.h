...
#define MASTEREFFECT_TOGGLEKEY	0x13	//[depending on keyboard layout] Key used to toggle all MasterEffect effects. See ReShade documentation for more info. 
...
#define fLookupTableMix			0.2	//[0.0 to 1.0] Amount of color change by lookup table. 0.0 means no change, 1.0 means full effect.
...
#define TechniStrength 			4.5	//[0.0 to 1.0] Strength of Technicolor effect. 0.0 means original image.
...
//DPX
#define DPXRed   			7.5  	//[1.0 to 15.0] Amount of DPX applies on Red color channel
#define DPXGreen 			6.0  	//[1.0 to 15.0] ""
#define DPXBlue  			7.5  	//[1.0 to 15.0] ""
#define DPXColorGamma    		3.0  	//[0.1 to 2.5] Adjusts the colorfulness of the effect in a manner similar to Vibrance. 1.0 is neutral.
#define DPXSaturation 			1.5  	//[0.0 to 8.0] Adjust saturation of the effect. 1.0 is neutral.
#define DPXRedC   			0.56 	//[0.60 to 0.20] 
#define DPXGreenC 			0.36 	//[0.60 to 0.20]
#define DPXBlueC  			0.44 	//[0.60 to 0.20]
...
#define RGB_Gamma 		float3(1.199, 1.199, 1.199)  //[0.000 to 2.000] Adjust midtones for Red, Green and Blue
...
#define Exposure    			-1.430  	//[-1.000 to 1.000] Adjust exposure
#define Saturation  			0.000  	//[-1.000 to 1.000] Adjust saturation
#define Bleach      			1.10	//[0.000 to 1.000] Brightens the shadows and fades the colors
#define Defog       			0.017  	//[0.000 to 1.000] How much of the color tint to remove
#define FogColor 			float3(0.00, 2.00, 0.55) //[0.00 to 2.55, 0.00 to 2.55, 0.00 to 2.55] What color to remove - default is blue
...
//FILMICPASS
#define Strenght			0.65  	//[0.05 to 1.5] Strength of the color curve altering
...
#define FBleach				-0.5	//[-0.5 to 1.0] More bleach means more contrasted and less colorful image
#define FRedCurve			6.0 
#define FGreenCurve			6.0
#define FBlueCurve			1.0
#define BaseCurve			1.5
#define EffectGammaR			1.2
#define EffectGammaG			1.0
#define EffectGammaB			1.2
#define EffectGamma			1.25
...
#define ColormodContrastR 		1.50  	// Contrast for Red color channel
#define ColormodContrastG 		1.50  	// ...
#define ColormodContrastB 		1.50  	// ...
#define ColormodBrightnessR 		-0.09   // Brightness for Red color channel
#define ColormodBrightnessG 		-0.09   // ...
#define ColormodBrightnessB 		-0.09   // ...

//SPHERICAL TONEMAP
#define sphericalAmount 		2.0	//[0.0 to 2.0] Amount of spherical tonemapping applied...sort of
...
//LENSDIRT
#define fLensdirtIntensity 		0.9       //[0.0 to 2.0] Intensity of lensdirt.
#define fLensdirtSaturation		2.0	//[0.0 to 2.0] Color saturation of lensdirt.
#define fLensdirtTint		float3(1.0,1.0,1.2) //[0.0 to 1.0] R, G and B components of lensdirt tintcolor the lensdirt color gets shifted to.
...
#define fAnamFlareThreshold		0.98	//[0.1 to 1.0] Every pixel brighter than this value gets a flare.
#define fAnamFlareWideness		2.1	//[1.0 to 2.5] Horizontal wideness of flare. Don't set too high, otherwise the single samples are visible
#define fAnamFlareAmount		5.0	//[1.0 to 20.0] Intensity of anamorphic flare.
#define fAnamFlareCurve			1.0	//[1.0 to 2.0] Intensity curve of flare with distance from source
...
#define fBloomTint 		float3(0.9,0.8,1.0) //[0.0 to 1.0] R, G and B components of bloom tintcolor the bloom color gets shifted to.
...
#define fLenzIntensity 			0.6 	//[0.2 to 3.0] power of lens flare effect
...
#define fGodrayWeight			1.0	//[0.8 to 1.7] weighting
#define fGodrayDensity			0.7	//[0.2 to 2.0] Density of rays, higher means more and brighter rays
...
#define AO_METHOD			4	//[1 to 2] 1: SSAO | 2: Raymarch AO | 3: HBAO | 4: SSGI | 5: Raymarch HBAO | 6: Alchemy SAO
#define AO_TEXSCALE   			1.0	//[0.25 to 1.0] Scale of AO resolution, 1.0 means fullscreen. Lower resolution means less pixels to process and more performance but also less quality.
#define AO_SHARPNESS			1.2	//[0.05 to 2.0] 1: AO sharpness, higher means more sharp geometry edges but noisier AO, less means smoother AO but blurry in the distance.
...
#define AO_LUMINANCE_UPPER		0.3	//[0.0 to 1.0] Upper brightness threshold where AO starts to fade out. Above this threshold AO is 0.
#define AO_FADE_START			0.6	//[0.0 to 1.0] Distance from camera where AO starts to fade out. 0.0 means camera itself, 1.0 means infinite distance.
#define AO_FADE_END			1.0	//[0.0 to 1.0] Distance from camera where AO fades out completely. 0.0 means camera itself, 1.0 means infinite distance.
...
#define iHBAOSamples			5	//[7 to 36] Amount of samples. Higher means more accurate AO but also less performance.
#define fHBAOSamplingRange		1.3	//[0.5 to 5.0] Range of HBAO sampling. Higher values ignore small geometry details and shadow more globally.
...
#define fHBAOAttenuation		0.03	//[0.001 to 0.2] Affects the HBAO range, prevents shadowing of very far objects which are close in screen space.
...
#define fSSGIIlluminationMult 		1.5	//[1.0 to 8.0] Multiplier of SSGI illumination (color bouncing/reflection).
#define fSSGIOcclusionMult 		9.8	//[1.0 to 10.0] Multiplier of SSGI occlusion.
...
#define iRayHBAO_StepCount  		2	//[5 to 32] Amount of steps to march per direction to check for occluders.
#define iRayHBAO_StepDirections  	8	//[5 to 25] Amount of rays / directions to march to check for occluders.
#define fRayHBAO_SampleRadius  		0.006	//[0.001 to 0.01] Range of AO sampling. Higher values ignore small geometry details and shadow more globally.
#define fRayHBAO_Attenuation  		0.4	//[0.4 to 5.0] Sampling attenuation. Used for ignoring objects that are close onscreen but actually far away (i.e. sky and player).
...
#define fSAOIntensity 			9.0	//[1.0 to 10.0] Linearly multiplies AO intensity.	
#define fSAOClamp 			3.0	//[1.0 to 10.0] Higher values shift AO more into black. Useful for light gray AO caused by high SAO radius.
#define fSAORadius 			3.0	//[1.0 to 10.0] SAO sampling radius. Higher values also lower AO intensity extremely because of Alchemy's extremely retarded falloff formula.
...
//SHARPEN
#define fSharpBias  	     		0.95	//[0.05 to 1.0] How big the sharpen offset is (used to compare neighbor pixels to get sharpen amount
#define fSharpStrength 			0.10	//[0.05 to 1.0] Amount of sharpening you want.
#define fSharpClamp 			1.8	//[0.2 to 2.0] Clamps the sharpening to a maximum amount to prevent aliasing

//FISHEYE, CHROMATIC ABBERATION
#define fFisheyeZoom			0.535   //[0.5 to 1.0] some lens zoom to hide bugged edges due to texcoord modification
#define fFisheyeDistortion	 	0.1  	//[-0.3 to 0.3] distortion of image, fish eye effect
#define fFisheyeDistortionCubic		0.1	//[-0.3 to 0.3] distortion of image, fish eye effect, cube based
#define fFisheyeColorshift	        0.006   //[-0.1 to 0.1] Amount of color shifting

//IMAGE GRAIN
#define fGrainSaturation 		0.3	//[0.0 to 2.0] Saturation of Grain. Higher means more colored noise, 0.0 means blacknwhite no TV signal noise.
#define fGrainIntensityBright 		0.06	//[0.0 to 2.0] Intensity of Grain in bright areas.
#define fGrainIntensityMid 		0.06	//[0.0 to 2.0] Intensity of Grain in midtone areas.
#define fGrainIntensityDark 		0.06	//[0.0 to 2.0] Intensity of Grain in dark areas.
...
//BORDER
#define fBorderWidth float2(0,60)        	//[0 to 2048, 0 to 2048] (X,Y)-width of the border. Measured in pixels. If this is set to 0,0 then the border_ratio will be used instead
...
#define fBorderColor float3(0.0, 0.0, 0.0)  	//[0.0 to 1.0] What color the border should be. In RGB colors, 0,0,0 is black, 1,1,1 is pure white.
...
#define CurveCE_Mask          1 //[0|1|2|3] //-0 = Off, 1 = On, 2 = Curve Dark Halos Only, 3 = Curve Light Halos Only.
#define CurveCE_Strength   3.00 //[0.00:3.00] //-Higher #'s = stronger effect.
#define CE_MaskWidth       7.00 //[0.00:10.00] //-#'s > 1 = bigger radius, #'s < 1 = smaller radius
#define CE_MaskQuality        1 //[0:5] //-Higher #'s = more blur passes (Wider, smoother blur). Higher performance cost.
#define ViewCE_Mask           0 //[0:1] //-Set to 1 to view the CE_Mask. Helpful when adjusting mask settings. 
#define CE_BlendMode          3 //[1|2|3|5|6|7] //-1 = Soft Light(weak), 2 = Overlay(neutral), 3 = Multiply, 4 = Hard Light, 5 = Vivid Light, 6 = Soft Light#2(lighter), 7 = Soft Light#3(darker)
#define CE_Strength        0.80 //[-3.00:3.00] //-Strength of the Contrast Enhancement effect.

//>Advanced Contrast Enhancement Settings
#define ClampDarkHalosCE      0.45 //[0.00:0.50] //-Limits the amount of contrast enhancement done to dark pixels. Setting to 0.50 = no contrast enhancement on dark pixels.
...
#define MidMaskDarkCE         0.35 //[0.00:1.00] //-Default = 0.35. Still experimenting with these settings. Higher values should increase the amount of contrast enhancement done in dark areas. Sometimes it will do the opposite.
...
//---- Effects Toggle Key ----
#define HighPass_ToggleKey   0x2D  //Default is "INSERT". See the "KeyCodes" document in the SweetFX folder to change.

#define Compatibility           2  //0 = off, 1 = SweetFX, 2 = MasterEffect

//---- Chain Additional .fx files ----
//-- This file will run BEFORE the Gaussian effects --
#define USE_EFFECT1           0  //[0 or 1] 0 = off, 1 = on.
#define FX_FILE1  "FileName.fx"  //File name must be in "quotes"
//-- This file will run BEFORE the Gaussian effects --
#define USE_EFFECT2           0  //[0 or 1] 0 = off, 1 = on.
#define FX_FILE2  "FileName.fx"  //File name must be in "quotes"
//-- This file will run AFTER the Gaussian effects --
#define USE_EFFECT3           0  //[0 or 1] 0 = off, 1 = on. 
#define FX_FILE3  "FileName.fx"  //File name must be in "quotes"
//-- This file will run AFTER the Gaussian effects --
#define USE_EFFECT4           0  //[0 or 1] 0 = off, 1 = on.
#define FX_FILE4  "FileName.fx"  //File name must be in "quotes"
